...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/Teddy/Desktop/Psychopy task/sternberg scanner/sternberg_scanner.py',
...
t = 0
exampleinstructionsClock.reset()  # clock
frameN = -1
continueRoutine = True
# update component parameters for each repeat
...
# -------Start Routine "exampleinstructions"-------
while continueRoutine:
    # get current time
...
for thisBlock in block:
    ...
    while continueRoutine:
        ...
        # *key_resp_6* updates
        if t >= 2.0 and key_resp_6.status == NOT_STARTED:
            # keep track of start time/frame for later
    ...
    for thisBlockrepeat in blockrepeat:
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            # *text_4* updates
            if t >= 1.4 and text_4.status == NOT_STARTED:
                # keep track of start time/frame for later
                text_4.tStart = t  # not accounting for scr refresh
                text_4.frameNStart = frameN  # exact frame index
                win.timeOnFlip(text_4, 'tStartRefresh')  # time at next scr refresh
                text_4.setAutoDraw(True)
            frameRemains = 1.4 + 6.2- win.monitorFramePeriod * 0.75  # most of one frame period left
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            frameRemains = 0.0 + 1.8- win.monitorFramePeriod * 0.75  # most of one frame period left
        ...
        for thisResponserepeat in responserepeat:
            ...
            while continueRoutine and routineTimer.getTime() > 0:
                ...
                # *text_5* updates
                if t >= .8 and text_5.status == NOT_STARTED:
                    # keep track of start time/frame for later
                    text_5.tStart = t  # not accounting for scr refresh
                    text_5.frameNStart = frameN  # exact frame index
                    win.timeOnFlip(text_5, 'tStartRefresh')  # time at next scr refresh
                    text_5.setAutoDraw(True)
                frameRemains = .8 + 1.2- win.monitorFramePeriod * 0.75  # most of one frame period left
                ...
                # *key_resp_5* updates
                if t >= .8 and key_resp_5.status == NOT_STARTED:
                    # keep track of start time/frame for later
